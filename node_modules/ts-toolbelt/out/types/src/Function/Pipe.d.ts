...
declare type PipeFnSync<Fns extends Function[], K extends keyof Fns> = K extends '0' ? Fns[K] : Function<[// handling unknown generics, waiting for proposal
...
declare type PipeFnAsync<Fns extends Function[], K extends keyof Fns> = K extends '0' ? PromiseOf<Fns[K]> : Function<[// handling unknown generics, waiting for proposal
