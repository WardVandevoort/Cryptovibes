...
declare type ComposeFnSync<Fns extends Function[], K extends keyof Fns> = Length<Tail<Fns>> extends Format<K & string, 'n'> ? Fns[K] : Function<[// handling unknown generics, waiting for proposal
...
declare type ComposeFnAsync<Fns extends Function[], K extends keyof Fns> = Length<Tail<Fns>> extends Format<K & string, 'n'> ? PromiseOf<Fns[K]> : Function<[// handling unknown generics, waiting for proposal
 ...
 * ```
 */
export declare type Composer<Fns extends Function[], mode extends Mode = 'sync'> = {
    'sync': {
 ...
 */
export declare type Compose<Fns extends Function[], mode extends Mode = 'sync'> = {
