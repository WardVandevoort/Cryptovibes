...
declare type __TupleOf<O extends object, K, TN extends any[] = [], I extends Iteration = IterationOf<'0'>> = {
    0: __TupleOf<O, Exclude<K, Key<I>>, PickIfEntry<O, TN, I>, Next<I>>;
    1: TN;
}[Equals<K, never> extends True ? 1 : 0];
declare type _TupleOf<O extends object> = __TupleOf<O, keyof O> extends infer X ? Cast<X, any[]> : never;
 ...
 * ```
 */
export declare type TupleOf<O extends object> = O extends unknown ? _TupleOf<O> : never;
export {};
