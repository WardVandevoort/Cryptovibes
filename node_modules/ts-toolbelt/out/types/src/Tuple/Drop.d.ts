...
declare type _Drop<T extends Tuple, N extends Number, I extends Iteration = IterationOf<'0'>> = {
 ...
 * ```
 */
export declare type Drop<T extends Tuple, N extends Number, way extends Way = '->'> = {
    '->': _Drop<T, N>;
