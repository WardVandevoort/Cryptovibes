...
declare type _Take<T extends Tuple, N extends Number, TN extends Tuple = [], I extends Iteration = IterationOf<'0'>> = {
 ...
 * ```
 */
export declare type Take<T extends Tuple, N extends Number, way extends Way = '->'> = {
    '->': Reverse<_Take<T, N>>;
    '<-': _Take<Reverse<T>, N>;
